...
#define DEFINE_TEMPLATE_FUNCTIONS(_Type)                                      \
    ...
    template Matrix2d<_Type> eye(std::size_t, const _Type &);                 \
    template Matrix2d<_Type> zeros(std::size_t);                              \
    template Matrix2d<_Type> zeros(std::size_t, std::size_t);                 \
    template Matrix2d<_Type> randn(std::size_t, std::size_t, std::mt19937 &); \
    ...
    DEFINE_TEMPLATE_FUNCTIONS(unsigned char)
